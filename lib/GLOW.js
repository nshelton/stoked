...
GLOW.Compiler = function() {
    ...
    b.compileVertexShader = function(a) {
        ...
        !GL.getShaderParameter(c, GL.COMPILE_STATUS) &&
            !GL.isContextLost() && console.log(a) && 
            GLOW.error("GLOW.Compiler.compileVertexShader: " + GL.getShaderInfoLog(c) );
        return c
    };
    b.compileFragmentShader = function(a) {
        ...
        GL.compileShader(c);
        !GL.getShaderParameter(c, GL.COMPILE_STATUS) &&
         !GL.isContextLost() && console.log(GL.getShaderInfoLog(c)) &&
         GLOW.error("GLOW.Compiler.compileFragmentShader: " + GL.getShaderInfoLog(c));
        return c
    };
    b.linkProgram = function(a, c) {
        ...
        !GL.getProgramParameter(b, GL.LINK_STATUS) && !GL.isContextLost() && 
        console.log(GL.getProgramInfoLog(b)) && GLOW.error("GLOW.Compiler.linkProgram: Could not initialise program");
        return b
    };
